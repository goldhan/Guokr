...
+ (void)alartLikeShow:(UIViewController *)VC with:(BOOL)ret{
    ...
    [RKDropdownAlert title:(NSString*)@"提示" message:(NSString*)message backgroundColor:(UIColor*)[UIColor colorWithRed:1.000 green:0.847 blue:0.551 alpha:1.000] textColor:(UIColor*)[UIColor whiteColor] time:(NSInteger)3 ] ;
